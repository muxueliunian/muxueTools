...
type DatabaseConfig struct {
    Path string `mapstructure:"path" default:"data/MuxueTools.db"`
}
```
...
update:
  ...
  github_repo: "muxueliunian/MuxueTools"     # GitHub 仓库
...
```powershell
# 编译带图标的 Windows 桌面应用
go build -ldflags="-s -w -H windowsgui" -o bin/MuxueTools.exe ./cmd/desktop
...
**变更记录**:
- 2026-01-26: 添加安装程序架构章节 (Section 10)，更新目录结构

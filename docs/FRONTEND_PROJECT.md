...
| `/stats` | stats | StatsView.vue | ✅ 完成 |
| `/settings` | settings | SettingsView.vue | ✅ 完成 |
...
- **Settings**: 配置表单完成
- **Stats**: 统计页面完成 (ECharts 趋势图 + 模型使用分布)
...
*最后更新: 2026-01-20 (Proxy Key Sync + Project Rename)*
